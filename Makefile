...
apply_a:
	cd ./terraform && terraform apply -target module.network_layer -target module.security_layer -target module.database_layer -target local_file.ansible_vars -target module.cache_layer --auto-approve && cd -

apply_b:
	cd ./terraform && terraform apply -target module.front_layer -target module.app_layer --auto-approve && cd -

destroy_a:
	cd ./terraform && terraform destroy -target module.network_layer -target module.security_layer -target module.database_layer -target local_file.ansible_vars -target module.cache_layer --auto-approve && cd -
