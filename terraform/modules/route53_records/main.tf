resource "aws_route53_record" "records" {
    ...
    set_identifier              = "${var.weighted_routing_policy != null ? "weighted-policy" :  var.latency_routing_policy != null ? "latency-policy" : var.geolocation_routing_policy != null ? "geolocation-policy" : var.failover_routing_policy != null ? "failover-policy" : null}"
